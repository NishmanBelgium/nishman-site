...
const VERSION = "nishman-v152";
const SOCLE = [
  "/produits/",
  "/assets/css/site.css?v=152",
  "/assets/js/catalog.js?v=152",
  "/assets/js/offre.js?v=152",
  "/assets/js/config.js?v=152",
  "/assets/data/products.json?v=152",
