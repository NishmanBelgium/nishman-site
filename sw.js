...
const VERSION = "nishman-v153";
const SOCLE = [
  "/produits/",
  "/assets/css/site.css?v=153",
  "/assets/js/catalog.js?v=153",
  "/assets/js/offre.js?v=153",
  "/assets/js/config.js?v=153",
  "/assets/data/products.json?v=153",
