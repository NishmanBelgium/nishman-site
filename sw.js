...
const VERSION = "nishman-v148";
const SOCLE = [
  "/produits/",
  "/assets/css/site.css?v=148",
  "/assets/js/catalog.js?v=148",
  "/assets/js/offre.js?v=148",
  "/assets/js/config.js?v=148",
  "/assets/data/products.json?v=148",
