...
const VERSION = "nishman-v156";
const SOCLE = [
  "/produits/",
  "/assets/css/site.css?v=156",
  "/assets/js/catalog.js?v=156",
  "/assets/js/offre.js?v=156",
  "/assets/js/config.js?v=156",
  "/assets/data/products.json?v=156",
