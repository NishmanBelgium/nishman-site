...
const VERSION = "nishman-v157";
const SOCLE = [
  "/produits/",
  "/assets/css/site.css?v=157",
  "/assets/js/catalog.js?v=157",
  "/assets/js/offre.js?v=157",
  "/assets/js/config.js?v=157",
  "/assets/data/products.json?v=157",
